...
const EditorPdp: React.FC<FormProps> = ({ onFormSubmit }) => {
      ...
      <div className="optionStripBanner">
        ...
        <div className="innerDiv">
          <div className="LayoutTemplate">
            ...
            {formData.select === "2" && formData.device !== "Mobile" && (
              <>
                <div className="offer">
            ...
            {formData.select === "3" && formData.device !== "Mobile" ? (
              <>
                <div className="offer">
                  <div className="titleBold">Offer strip 2:</div>
                  <FormInput
