...
const PreviewCodeCtp: React.FC<PreviewCodeProps> = ({
  ...
  "campaign":"${
    selectCampaign
      ? selectCampaign === "Paramter"
        ? campaign
        : selectCampaign.toLowerCase()
      : "default"
  }",
  ...
  ImageLink
    ...
    ${
      height && device === "Desktop"
        ? `,"height":"${height.toLocaleLowerCase()}"`
        : ""
    }    
 ...
 ${
   headline
     ? `,"banner_h1_text": "${headline}" ${
         textcolorheadline ? `,"banner_h1_color":"${textcolorheadline}"` : ""
       } `
     : ""
 }
 ${
   subheadline
     ? `,"banner_h2_text": "${subheadline}" ${
         textcolorsubheadline
           ? `,"banner_h2_color":"${textcolorsubheadline}"`
           : ""
       } `
     : ""
 }
