...
const EditorCtp: React.FC<FormProps> = ({ onFormSubmit }) => {
  ...
  const handleInputChange = (fieldName: string, value: string) => {
    setFormData((prevData) => {
      ...
      // Update the relevant linetext based on the selected offer
      if (fieldName === "offerSelect") {
        const selectedOffer = cmsBlockOffers.find(
          (offer) => offer.offer === value
        );
        if (selectedOffer) {
          updatedData.linetext = selectedOffer.offer; // Populate linetext with offer details
          updatedData.discountValue = selectedOffer.discountValue; // Populate discountValue
          updatedData.code = selectedOffer.code;
          updatedData.mdHeadline = selectedOffer.detailsHeadline; // Populate code
          updatedData.mdContent = selectedOffer.details;
          updatedData.selectDsicountType = selectedOffer.discountType;
          if (updatedData.linetext == "Add new offer") {
            updatedData.linetext = "";
          }
        }
      } else if (fieldName === "offerSelectTwo") {
        const selectedOffer = cmsBlockOffers.find(
          (offer) => offer.offer === value
        );
        if (selectedOffer) {
          updatedData.linetexttwo = selectedOffer.offer; // Populate linetext with offer details
          updatedData.discountValueTwo = selectedOffer.discountValue; // Populate discountValue
          updatedData.codeTwo = selectedOffer.code;
          updatedData.mdHeadlineTwo = selectedOffer.detailsHeadline; // Populate code
          updatedData.mdContentTwo = selectedOffer.details;
          updatedData.selectDsicountTypeTwo = selectedOffer.discountType;
          if (updatedData.linetexttwo == "Add new offer") {
            updatedData.linetexttwo = "";
          }
        }
      } else if (fieldName === "offerSelectThree") {
        const selectedOffer = cmsBlockOffers.find(
          (offer) => offer.offer === value
        );
        if (selectedOffer) {
          updatedData.linetextthree = selectedOffer.offer; // Populate linetext with offer details
          updatedData.discountValueThree = selectedOffer.discountValue; // Populate discountValue
          updatedData.codeThree = selectedOffer.code;
          updatedData.mdHeadlineThree = selectedOffer.detailsHeadline; // Populate code
          updatedData.mdContentThree = selectedOffer.details;
          updatedData.selectDsicountTypeThree = selectedOffer.discountType;
          if (updatedData.linetextthree == "Add new offer") {
            updatedData.linetextthree = "";
          }
        }
      }
        ...
        <div className="innerDiv">
          <div className="LayoutTemplate">
            ...
            <div className="offer">
              ...
              <FormInput
                label="Offer Types"
                value={formData.offerSelect}
                onChange={(value) => handleInputChange("offerSelect", value)}
                type="select"
                classN="layoutSelect"
                placeholder="Offer"
                options={[
                  { value: "Choose offer", text: "Choose offer" },
                  ...cmsBlockOffers.map((offer) => ({
                    value: offer.offer,
                    text: offer.offer,
                  })),
                ]}
              />
              {formData.offerSelect !== "Choose offer" ? (
                <>
                  <FormInput
                    label=""
                    value={formData.linetext}
                    onChange={(value) => {
                      handleInputChange("linetext", value); // Set the selected offer in the linetext field
                    }}
                    type="text"
                    classN="inputLineText"
                    placeholder="Offer"
            ...
            {formData.select === "2" && (
              <div className="offer">
                ...
                <FormInput
                  label="Offer Types"
                  value={formData.offerSelectTwo}
                  onChange={(value) =>
                    handleInputChange("offerSelectTwo", value)
                  }
                  type="select"
                  classN="layoutSelect"
                  placeholder="Offer"
                ...
                />
                {formData.offerSelectTwo !== "Choose offer" ? (
                  <>
                    <FormInput
                      label=""
            ...
            {formData.select === "3" ? (
              <>
                  ...
                  {formData.offerSelectTwo !== "Choose offer" ? (
                    <>
                      ...
                      <FormInput
                        ...
                        value={formData.codeTwo}
                        onChange={(value) =>
                          handleInputChange("codeTwo", value)
                        }
                        type="text"
                        classN="inputLineText"
                        placeholder="Code"
                ...
                <div className="offer">
                  ...
                  <FormInput
                    label="Offer Types"
                    value={formData.offerSelectThree}
                    onChange={(value) =>
                      handleInputChange("offerSelectThree", value)
                    }
                    type="select"
                    classN="layoutSelect"
                    placeholder="Offer"
                  ...
                  />
                  {formData.offerSelectThree !== "Choose offer" ? (
                    <>
                      <FormInput
                        label=""
                      ...
                      <FormInput
                        ...
                        onChange={(value) =>
                          handleInputChange("codeThree", value)
                        }
                        type="text"
                        classN="inputLineText"
                        placeholder="Code"
          ...
          <div className="offer">
            <div className="titleBold">Promotion Name:</div>
            <FormInput
              label=""
              ...
              type="text"
              classN="inputLineText"
              placeholder="Details - Promotion name"
            />
          </div>
          {formData.select == "1" ? (
            ""
